...
echo pc build started for Release Win32 config...
mkdir Release 2>NUL

%BUILDENV%\MSBuild.exe pc.sln /t:Rebuild /p:Configuration=Release /p:Platform=Win32 > Release/Release_win32.log
